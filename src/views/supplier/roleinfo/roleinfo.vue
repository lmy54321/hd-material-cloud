  ...
  <div style="width: 100%">
    <el-row type="flex">
      <el-col :span="7" style="margin-top: 15px;display: flex;align-items: center">
        <span style="width:85px">角色查询：</span>
        <el-date-picker
          v-model="value2"
          type="daterange"
          align="right"
      ...
      <el-col :span="4" style="margin-top: 15px;display: flex;align-items: center">
        <el-input placeholder="请输角色名称" v-model="input3">
        </el-input>
    ...
    data: function () {
      return {
        ...
        rules: {
          ...
          job_introduce: [
            {required: true, message: '请输入角色介绍', trigger: 'change'}
          ],
          job_remark: [
